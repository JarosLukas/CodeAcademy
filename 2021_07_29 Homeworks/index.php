...
<body>
  <div class="container mt-5">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="galery-tab" data-bs-toggle="tab" data-bs-target="#galery" type="button" role="tab" aria-controls="galery" aria-selected="false">Galery</button>
      </li>
    </ul>
      ...
      <div class="tab-pane fade show active" id="upload" role="tabpanel" aria-labelledby="upload-tab">
        <form action="upload.php" method="POST" enctype="multipart/form-data">
            <div class="input-group mb-3">
                <textarea class="form-control" aria-label="With textarea" name="description" id="description" placeholder="Description"></textarea>
            </div>
